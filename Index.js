...
client.on("guildMemberAdd", async member => {
  ...
  .setDescription(`Welcome To Our Server ${member.user}. We are happy to have you! you are member number ${member.guild.memberCount}. Please read don't forget to read our rules! ${discord.channel.#rules}`)
  .setColor('BLUE')
